...
def test_registration_sync():
    ...
    data = {
        "email": "test.sync3@example.com",
        "password": "TestPassword123!",
        "name": "Test Sync User 3",
        "role": "patient"
    }
    ...
    try:
        ...
        if response.status_code in [200, 201]:
            ...
            if users_response.status_code == 200:
                print("✅ User successfully synchronized between services!")
                return True
            else:
                print("❌ User not found in Users service - sync failed")
                return False
        else:
