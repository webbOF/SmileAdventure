    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {professional.services.map((service, index) => (
                <button
                  ...
                  className={`p-4 border rounded-md text-left ${selectedService === service
              ...
              <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-3">
                {availableTimes.map(time => (
                  <button
                    ...
                    className={`py-2 px-3 rounded-md text-center ${selectedTime === time
                        ? 'bg-blue-600 text-white'
          ...
          <div className="mt-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Riepilogo prenotazione</h3>
            <div className="bg-gray-50 p-4 rounded-md">
              <p className="text-sm text-gray-600 mb-2">
                <span className="font-medium">Servizio:</span> {selectedService}
              </p>
              <p className="text-sm text-gray-600 mb-2">
                <span className="font-medium">Data:</span> {selectedDate ? selectedDate.toLocaleDateString('it-IT') : 'Non selezionata'}
              </p>
              <p className="text-sm text-gray-600 mb-2">
                <span className="font-medium">Orario:</span> {selectedTime || 'Non selezionato'}
              </p>
            </div>
          </div>
