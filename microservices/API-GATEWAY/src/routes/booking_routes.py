...
async def create_complete_booking(
    ...
    try:
        async with httpx.AsyncClient() as client:
            ...
            # 3. Invia notifica di conferma prenotazione
            # Qui dovresti integrare la logica per inviare una notifica all'utente
            # Ad esempio, inviare un'email o un SMS di conferma
